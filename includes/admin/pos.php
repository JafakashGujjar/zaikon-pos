...
<!-- Open Shift Modal -->
<div id="rpos-open-shift-modal" class="zaikon-modal" style="display: none;">
    <div class="zaikon-modal-content zaikon-animate-scaleIn" style="max-width: 500px;">
        <div class="zaikon-modal-header">
            <h3><?php echo esc_html__('Open Shift', 'restaurant-pos'); ?></h3>
        </div>
        <div class="zaikon-modal-body">
            <p><?php echo esc_html__('Please enter the opening cash amount in your drawer to start your shift.', 'restaurant-pos'); ?></p>
            <div class="zaikon-order-field" style="margin-top: 20px;">
                <label><?php echo esc_html__('Opening Cash Amount (Rs):', 'restaurant-pos'); ?> <span style="color: var(--zaikon-red);">*</span></label>
                <input type="number" id="rpos-opening-cash" step="0.01" min="0" value="0.00" placeholder="0.00" inputmode="numeric" style="width: 100%; padding: 10px; font-size: 18px;">
            </div>
            <div class="zaikon-order-field" style="margin-top: 15px;">
                <label><?php echo esc_html__('Notes (optional):', 'restaurant-pos'); ?></label>
                <textarea id="rpos-opening-notes" rows="2" placeholder="<?php echo esc_attr__('e.g., Morning shift, Weekend opening', 'restaurant-pos'); ?>"></textarea>
            </div>
        </div>
        <div class="zaikon-modal-footer">
            <button class="zaikon-btn zaikon-btn-primary" id="rpos-confirm-open-shift">
                <?php echo esc_html__('Start Shift', 'restaurant-pos'); ?>
            </button>
        </div>
    </div>
</div>
...
<!-- Close Shift Modal -->
<div id="rpos-close-shift-dropdown" class="zaikon-modal" style="display: none;">
    <div class="zaikon-modal-content zaikon-animate-scaleIn" style="max-width: 600px;">
        <div class="zaikon-modal-header">
            ...
            <button class="zaikon-modal-close" id="rpos-close-shift-dropdown-close">&times;</button>
        </div>
        <div class="zaikon-modal-body">
        ...
        <div class="zaikon-expenses-dropdown-body">
            <div class="zaikon-expenses-form">
                ...
                <div class="zaikon-order-field">
                    ...
                    <select id="rpos-expense-category" class="zaikon-select">
                ...
                <div class="zaikon-order-field" id="rpos-expense-rider-field" style="display: none;">
                    <label><?php echo esc_html__('Rider:', 'restaurant-pos'); ?></label>
                    <select id="rpos-expense-rider" class="zaikon-select">
...
<div id="rpos-expenses-modal" class="zaikon-modal" style="display: none;">
    <div class="zaikon-modal-content zaikon-animate-scaleIn" style="max-width: 700px;">
        ...
        <div class="zaikon-modal-footer">
            <button class="zaikon-btn zaikon-btn-secondary" id="rpos-close-expenses">
...
<div id="rpos-orders-modal" class="zaikon-modal" style="display: none;">
    <div class="zaikon-modal-content zaikon-animate-scaleIn" style="max-width: 1200px;">
        <div class="zaikon-modal-header">
            <h3><?php echo esc_html__('My Orders', 'restaurant-pos'); ?></h3>
            <button class="zaikon-modal-close" id="rpos-orders-modal-close">&times;</button>
        </div>
        <div class="zaikon-modal-body">
            ...
            <div id="rpos-orders-list" style="max-height: 500px; overflow-y: auto;">
                <p style="text-align: center; color: var(--zaikon-gray-dark);"><?php echo esc_html__('Loading orders...', 'restaurant-pos'); ?></p>
            </div>
        </div>
        <div class="zaikon-modal-footer">
            <button class="zaikon-btn zaikon-btn-secondary" id="rpos-close-orders">
                <?php echo esc_html__('Close', 'restaurant-pos'); ?>
            </button>
        </div>
    </div>
...
<div id="zaikon-delivery-panel" class="zaikon-modal" style="display: none;">
    <div class="zaikon-modal-content zaikon-delivery-modal-content zaikon-animate-scaleIn">
        <div class="zaikon-modal-header zaikon-delivery-modal-header">
            <h3>
                <span class="dashicons dashicons-location-alt"></span>
                <?php echo esc_html__('Delivery Details', 'restaurant-pos'); ?>
            </h3>
            <button class="zaikon-modal-close zaikon-delivery-modal-close" id="zaikon-delivery-modal-close">&times;</button>
        </div>
        <div class="zaikon-modal-body zaikon-delivery-modal-body">
            <!-- Customer Information Section -->
            <div class="zaikon-delivery-section">
                <h4 class="zaikon-delivery-section-title">
                    <span class="dashicons dashicons-businessperson"></span>
                    <?php echo esc_html__('Customer Information', 'restaurant-pos'); ?>
                </h4>
                <div class="zaikon-delivery-fields-row">
                    <div class="zaikon-delivery-field">
                        <label for="zaikon-delivery-name"><?php echo esc_html__('Customer Name', 'restaurant-pos'); ?> <span class="required">*</span></label>
                    ...
                    <div class="zaikon-delivery-field">
                        <label for="zaikon-delivery-phone"><?php echo esc_html__('Phone Number', 'restaurant-pos'); ?> <span class="required">*</span></label>
                        <div class="zaikon-input-with-icon">
            ...
            <div class="zaikon-delivery-section">
                <h4 class="zaikon-delivery-section-title">
                    ...
                    <?php echo esc_html__('Delivery Address', 'restaurant-pos'); ?>
                </h4>
                <div class="zaikon-delivery-fields-row">
                    <div class="zaikon-delivery-field">
                        <label for="zaikon-delivery-area"><?php echo esc_html__('Delivery Area', 'restaurant-pos'); ?> <span class="required">*</span></label>
                        <div class="zaikon-input-with-icon">
                            <span class="dashicons dashicons-location"></span>
                    ...
                    <div class="zaikon-delivery-field">
                        <label for="zaikon-delivery-address"><?php echo esc_html__('Complete Address', 'restaurant-pos'); ?> <span class="required">*</span></label>
                        <div class="zaikon-input-with-icon">
                            <span class="dashicons dashicons-building"></span>
                            <input type="text" id="zaikon-delivery-address" placeholder="<?php echo esc_attr__('House #, Street, Landmark', 'restaurant-pos'); ?>" required>
                        </div>
                    </div>
                </div>
                <div class="zaikon-delivery-fields-row">
                    <div class="zaikon-delivery-field zaikon-delivery-field-full">
                        <label for="zaikon-delivery-instructions"><?php echo esc_html__('Special Instructions', 'restaurant-pos'); ?></label>
                        <div class="zaikon-input-with-icon">
                            <span class="dashicons dashicons-testimonial"></span>
                            <textarea id="zaikon-delivery-instructions" rows="2" placeholder="<?php echo esc_attr__('e.g., Call on arrival, Don\'t ring bell, Gate code', 'restaurant-pos'); ?>"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="zaikon-delivery-section zaikon-delivery-summary-section">
                <h4 class="zaikon-delivery-section-title">
                    <span class="dashicons dashicons-cart"></span>
                    <?php echo esc_html__('Order Summary', 'restaurant-pos'); ?>
                </h4>
                <div class="zaikon-delivery-summary-grid">
                    <div class="zaikon-delivery-summary-item">
                        <div class="zaikon-summary-icon-wrapper">
                            <span class="dashicons dashicons-admin-site-alt3"></span>
                        </div>
                        <div class="zaikon-summary-content">
                            <span class="zaikon-summary-label"><?php echo esc_html__('Distance', 'restaurant-pos'); ?></span>
                            <input type="text" id="zaikon-delivery-distance" class="zaikon-summary-value" placeholder="<?php echo esc_attr__('Auto-calculated', 'restaurant-pos'); ?>" readonly>
                        </div>
                    </div>
                    <div class="zaikon-delivery-summary-item">
                        <div class="zaikon-summary-icon-wrapper">
                        ...
                        <div class="zaikon-summary-content">
                            <span class="zaikon-summary-label"><?php echo esc_html__('Delivery Charge', 'restaurant-pos'); ?></span>
                            <div class="zaikon-delivery-charge-wrapper">
                                <input type="text" id="zaikon-delivery-charge" class="zaikon-summary-value" placeholder="<?php echo esc_attr__('Auto-calculated', 'restaurant-pos'); ?>" readonly>
            ...
            <div class="zaikon-delivery-section">
                <h4 class="zaikon-delivery-section-title">
                    ...
                    <?php echo esc_html__('Rider Assignment', 'restaurant-pos'); ?>
                </h4>
                <div class="zaikon-delivery-fields-row">
                    <div class="zaikon-delivery-field zaikon-delivery-field-full">
                        <label for="zaikon-delivery-rider"><?php echo esc_html__('Assign Rider', 'restaurant-pos'); ?></label>
                        <div class="zaikon-input-with-icon">
                            <span class="dashicons dashicons-admin-users"></span>
                            <select id="zaikon-delivery-rider">
                                <option value=""><?php echo esc_html__('-- Select Rider (Optional) --', 'restaurant-pos'); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <div class="zaikon-modal-footer zaikon-delivery-modal-footer">
            <button type="button" class="zaikon-btn zaikon-btn-secondary" id="zaikon-cancel-delivery">
                <span class="dashicons dashicons-no-alt"></span>
                <?php echo esc_html__('Cancel', 'restaurant-pos'); ?>
            </button>
            <button type="button" class="zaikon-btn zaikon-delivery-btn-primary" id="zaikon-save-delivery">
                <span class="dashicons dashicons-yes-alt"></span>
                <?php echo esc_html__('Confirm Delivery', 'restaurant-pos'); ?>
            </button>
        </div>
    </div>
</div>
